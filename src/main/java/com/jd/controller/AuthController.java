...
public class AuthController {
    ...
    public Map<String,Object> login(@RequestParam String userName,@RequestParam String password){
        ...
        if(StringUtils.equals(userName, "admin")&&StringUtils.equals(password, "admin")){
            ...
            //refreshToken设置过期时间
            redisTemplate.expire(refreshTokenKey, refreshTokenExpireTime, TimeUnit.MILLISECONDS);
    ...
    public Map<String,Object> refreshToken(@RequestParam String refreshToken){
        ...
        redisTemplate.opsForValue().set(String.format(jwtBlacklistKeyFormat, oldToken), "",tokenExpireTime, TimeUnit.MILLISECONDS);
